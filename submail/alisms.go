...
import (
	...
	"github.com/vannnnish/easyweb/util/json_tool"
...
func AliSendSmsCode(isNiuyan bool, t, lan, areaCode, phoneNum, code string) error {
	...
	paramBytes, _ := json_tool.Json().Marshal(param)
	if areaCode != "86" {
